...
_If set, indicates the maximum level of precision the value must have to be considered valid._





URI: [https://specification.margo.org/data-model/maxPrecision](https://specification.margo.org/data-model/maxPrecision)
Alias: maxPrecision
...
| ---  | ---  |
| self | https://specification.margo.org/data-model/maxPrecision |
| native | https://specification.margo.org/data-model/maxPrecision |
