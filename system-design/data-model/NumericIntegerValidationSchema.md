...
_Extends schema to define a integer-specific set of validation rules that can be used._
...
<!--
URI: [https://specification.margo.org/data-model/NumericIntegerValidationSchema](https://specification.margo.org/data-model/NumericIntegerValidationSchema)
-->
...
| [minValue](minValue.md) | 0..1 <br/> [integer](integer.md) | If set, indicates the minimum allowed integer value the value must have to be... | direct |
| [maxValue](maxValue.md) | 0..1 <br/> [integer](integer.md) | If set, indicates the maximum allowed integer value the value must have to be... | direct |
...
| ---  | ---  |
| self | https://specification.margo.org/data-model/NumericIntegerValidationSchema |
| native | https://specification.margo.org/data-model/NumericIntegerValidationSchema |
