...
Workloads are the software deployed to Margo-compliant edge compute devices. They are deployed [Components](../personas-and-definitions/technical-lexicon.md#component) of an [Application Pacakge](../personas-and-definitions/technical-lexicon.md#application-package). See the [workloads overview](workloads.md) page to learn more Margo's supported workloads and how they are packaged.
